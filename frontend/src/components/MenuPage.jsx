            ...
            <div key={d.id} className="relative flex flex-col rounded-xl bg-white p-4 text-center transition hover:shadow-md xl:p-5">
              ...
              {d.image_url ? (
                <img
                  src={d.image_url}
                  alt={d.name}
                  className="h-40 w-full rounded-lg object-contain xl:h-52"
                />
              ) : (
                <div className="flex h-40 w-full items-center justify-center text-gray-300 xl:h-52">
              ...
              <div className="mt-2.5 flex w-full items-center justify-between xl:mt-3.5">
                <span className="inline-block rounded-full bg-[#eef2f7] px-4 py-1.5 text-sm font-semibold text-gray-800 xl:px-5 xl:py-2 xl:text-base">
                  {formatPrice(d.price)}
                </span>
                {qty > 0 ? (
                  <div className="flex items-center rounded-full border border-gray-200">
                    <button
                      ...
                      className="flex h-8 w-7 items-center justify-center rounded-full text-base font-bold text-[#0c4a6e] transition hover:bg-gray-100 xl:h-10 xl:w-9 xl:text-lg"
                    >
                      −
                    </button>
                    <span className="w-5 text-center text-sm font-semibold text-gray-900 xl:w-6 xl:text-base">{qty}</span>
                    <button
                      type="button"
                      onClick={() => onQtyChange(d, qty + 1)}
                  ...
                  <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-full bg-[#a2d9f7] text-lg font-bold text-[#0c4a6e] shadow transition hover:brightness-95 xl:h-10 xl:w-10 xl:text-xl"
                  >
                    +
                  </button>
                )}
